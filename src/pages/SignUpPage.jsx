                ...
                <div className="w-96 text-white space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    >
                        ...
                        <div className="text-sm text-center text-white">
                            ...
                            <Link to={'/login'} className="text-center text-sm hover:underline font-bold text-white">Continue</Link>
                        </div>
                    </form>
                    <div className='flex flex-row text-center w-full mt-4'>
                        <div className='border-b-2 mb-2.5 mr-2 w-full'></div>
                        <div className='text-sm font-bold w-fit text-white'>OR</div>
                        <div className='border-b-2 mb-2.5 ml-2 w-full'></div>
                    </div>
                    <button
                        disabled={isRegistering}
                        onClick={onGoogleSignUp}
                        className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium text-white ${isRegistering ? 'cursor-not-allowed' : 'hover:bg-gray-100 transition duration-300 active:bg-gray-100'}`}>
